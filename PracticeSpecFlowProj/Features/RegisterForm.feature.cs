...
namespace PracticeSpecFlowProj.Features
{
...
#line hidden
        ...
        public virtual void UserCheckingTheRegisterationForm(string initial, string firstName, string lastName, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User Checking the Registeration Form", @__tags);
#line 5
